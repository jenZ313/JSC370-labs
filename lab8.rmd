...
The rendered document is available on GitHub:  
[https://jenz313.github.io/JSC370-labs/lab8.html
](https://jenz313.github.io/JSC370-labs/lab8.html
)
...
The result does make sense but is not very helpful since it contains mostly meaningless words like "the" and "on", the only useful word here is "patient".
...
The result is much better without stopwords, it shows meaningful words like "skin" and "anesthesia" that are not shown in the previous part. It still contains words like "also" and "used", which I further filtered.
